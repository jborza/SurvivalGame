...
# affects rotation and stuff, 0-1
var time : float
...
func _ready():
	# how much to increase time by second
...
func _process(delta):
	...
	environment.environment.sky.sky_material.set("ground_top_color", sky_top_color.sample(time))
